...
#    Updated: 2022/09/20 23:30:46 by mohazerr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(DIR_SRCS)/$(DIR_LIST)/ft_lstnew.c \
$(DIR_SRCS)/$(DIR_LIST)/ft_lstadd_front.c \
$(DIR_SRCS)/$(DIR_LIST)/ft_lstsize.c \
$(DIR_SRCS)/$(DIR_LIST)/ft_lstlast.c \
